...
namespace bxtk::core {
    ...
    void bxtk::core::CanvasItemProxy::_enter_tree() {
        if (this->element != nullptr) {
            this->element->enterTree();
        }
    }
    
    void bxtk::core::CanvasItemProxy::_exit_tree() {
        if (this->element != nullptr) {
            this->element->exitTree();
        }
    }
    
    void bxtk::core::CanvasItemProxy::_ready() {
        if (this->element != nullptr) {
            this->element->ready();
        }
    }
    
    void bxtk::core::CanvasItemProxy::_process(double delta) {
        if (this->element != nullptr) {
            this->element->process(delta);
        }
    }
    
    void bxtk::core::CanvasItemProxy::_physics_process(double delta) {
        if (this->element != nullptr) {
            this->element->physicsProcess(delta);
        }
    }
    
    void bxtk::core::CanvasItemProxy::_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->input(event);
        }
    }
    
    void bxtk::core::CanvasItemProxy::_unhandled_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledInput(event);
        }
    }
    
    void bxtk::core::CanvasItemProxy::_unhandled_key_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledKeyInput(event);
        }
    }
    
    void bxtk::core::CanvasItemProxy::_shortcut_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
