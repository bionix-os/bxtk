...
namespace bxtk::core {
    ...
    class ViewportProxy : public ViewportNode {
        ...
        public:
            bxtk::core::Viewport* element = nullptr;
    ...
    class Viewport : public Element {
        ...
        public:
            ...
            bxtk::spatial::World3D* getWorld3D() {
                return new bxtk::spatial::World3D(viewport->get_world_3d().ptr());
            }

            void setWorld3D(bxtk::spatial::World3D* world) {
            ...
            bxtk::spatial::World3D* findWorld3D() {
                return new bxtk::spatial::World3D(viewport->find_world_3d().ptr());
            }
            ...
            bxtk::ui::Control* guiGetFocusOwner() {
                return new bxtk::ui::Control(viewport->gui_get_focus_owner());
            }

            bxtk::ui::Control* guiGetHoveredControl() {
                return new bxtk::ui::Control(viewport->gui_get_hovered_control());
            }
            ...
            void pushInput(bxtk::input::InputEvent* event, bool inLocalCoords = false) {
            ...
            void pushUnhandledInput(bxtk::input::InputEvent* event, bool inLocalCoords = false) {
