...
void bxtk::core::io::bindIoInterface(sol::state& lua) {
...
std::string bxtk::core::io::IoInterface::getLuaRequirePath(const std::string &path) const {
...
std::string bxtk::core::io::IoInterface::getFilePathFromLuaRequirePath(const std::string &path) const {
