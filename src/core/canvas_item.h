...
namespace bxtk::core {
    ...
    class CanvasItemProxy : public CanvasItemNode {
        ...
        public:
            bxtk::core::CanvasItem* element = nullptr;  
    ...
    public:
        ...
        void drawStyleBox(bxtk::ui::StyleBox* styleBox, Rect2 rect) {
        ...
        bxtk::input::InputEvent* makeInputLocal(bxtk::input::InputEvent* event) {
            return new bxtk::input::InputEvent(canvas_item->make_input_local(event->getInputEvent()).ptr());
        }
