...
void bxtk::core::bind_class_to_lua(sol::state& lua, const String& class_name) {
    // Get class info
    ...
    auto indexFunc = [class_name, &lua](Object *obj, const std::string key) {
        ...
        if (key_string.begins_with("emit_")) {
            ...
            auto connect_func = [obj, signal_name](sol::stack_object func) {
                ...
                Callable callable = bxtk::core::create_callable_from_lua_function(function);
    ...
    for (int i = 0; i < signal_list_ptr->size(); i++)
    {
        ...
        auto connect_func = [class_name, signal](godot::Object* obj, sol::variadic_args va) {
            ...
            //bxtk::core::SignalDB::add_signal(obj, signal["name"], callable);
            return callable;
        };
        ...
        auto disconnect_func = [class_name, signal](godot::Object* obj, sol::variadic_args va) {
            ...
            //bxtk::core::SignalDB::remove_signal(obj, signal["name"]);
        };
...
void bxtk::core::bind_all_godot_classes(sol::state& lua) {
...
void bxtk::core::initialize_lua(sol::state& lua) {
