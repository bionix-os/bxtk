...
namespace bxtk::spatial {
    ...
    class Sky : public bxtk::core::Resource {
    private:
    ...
    public:
        ...
        bxtk::core::Material* getSkyMaterial() {
            return new bxtk::core::Material(sky->get_material().ptr());
        }

        void setSkyMaterial(bxtk::core::Material* material) {
