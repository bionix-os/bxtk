...
void bxtk::spatial::bindBaseMaterial3D(sol::state_view& lua) {
    auto ut = lua.new_usertype<bxtk::spatial::BaseMaterial3D>("BaseMaterial3D",
        "new", sol::factories(
            []() { return new bxtk::spatial::BaseMaterial3D(); }
        ),
