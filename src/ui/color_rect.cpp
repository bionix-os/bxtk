...
namespace bxtk::ui {
    void bxtk::ui::ColorRectProxy::_enter_tree() {
        if (this->element != nullptr) {
            this->element->enterTree();
        }
    }

    void bxtk::ui::ColorRectProxy::_exit_tree() {
        if (this->element != nullptr) {
            this->element->exitTree();
        }
    }

    void bxtk::ui::ColorRectProxy::_ready() {
        if (this->element != nullptr) {
            this->element->ready();
        }
    }

    void bxtk::ui::ColorRectProxy::_process(double delta) {
        if (this->element != nullptr) {
            this->element->process(delta);
        }
    }

    void bxtk::ui::ColorRectProxy::_physics_process(double delta) {
        if (this->element != nullptr) {
            this->element->physicsProcess(delta);
        }
    }

    void bxtk::ui::ColorRectProxy::_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->input(event);
        }
    }

    void bxtk::ui::ColorRectProxy::_unhandled_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledInput(event);
        }
    }

    void bxtk::ui::ColorRectProxy::_unhandled_key_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledKeyInput(event);
        }
    }

    void bxtk::ui::ColorRectProxy::_shortcut_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
    ...
    void bindColorRect(sol::state& lua) {
        lua.new_usertype<ColorRect>("ColorRect",
            ...
            sol::base_classes, sol::bases<BaseObject, Element, bxtk::core::CanvasItem, Control>(),
