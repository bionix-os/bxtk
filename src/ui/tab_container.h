...
namespace bxtk::ui {
    ...
    class TabContainerProxy : public TabContainerNode {
        ...
        public:
            bxtk::ui::TabContainer* element = nullptr;
    ...
    class TabContainer : public Container {
        ...
        public:
            ...
            bxtk::desktop::Popup* getPopup() {
                return new bxtk::desktop::Popup(container->get_popup());
            }
            ...
            bxtk::core::Texture2D* getTabButtonIcon(int tab) {
                return new bxtk::core::Texture2D(container->get_tab_button_icon(tab).ptr());
            }
            ...
            bxtk::core::Texture2D* getTabIcon(int tab) {
                return new bxtk::core::Texture2D(container->get_tab_icon(tab).ptr());
            }
            ...
            void setTabButtonIcon(int tab, bxtk::core::Texture2D* icon) {
            ...
            void setTabIcon(int tab, bxtk::core::Texture2D* icon) {
                godot::Texture2D* iconTexture = 
                    icon != nullptr 
                        ? icon->getTexture2D() 
                        : nullptr;
