...
namespace bxtk::ui {
    ...
    class TextureProgressBarProxy : public TextureProgressBarNode {
        ...
        public:
            bxtk::ui::TextureProgressBar* element = nullptr;
    ...
    class TextureProgressBar : public Range {
        ...
        public:
            ...
            bxtk::core::Texture2D* getTextureOver() {
                return new bxtk::core::Texture2D(proxy->get_over_texture().ptr());
            }

            void setTextureOver(bxtk::core::Texture2D* texture) {
                proxy->set_over_texture(texture->getTexture2D());
            }

            bxtk::core::Texture2D* getTextureProgress() {
                return new bxtk::core::Texture2D(proxy->get_progress_texture().ptr());
            }

            void setTextureProgress(bxtk::core::Texture2D* texture) {
            ...
            bxtk::core::Texture2D* getTextureUnder() {
                return new bxtk::core::Texture2D(proxy->get_under_texture().ptr());
            }

            void setTextureUnder(bxtk::core::Texture2D* texture) {
