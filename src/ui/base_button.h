...
namespace bxtk::ui {
    ...
    class BaseButtonProxy : public BaseButtonNode {
        ...
        public:
            bxtk::ui::BaseButton* element = nullptr;
    ...
    class BaseButton : public bxtk::ui::Control {
        private:
        ...
        public:
            ...
            bxtk::input::Shortcut* getShortcut() {
                return new bxtk::input::Shortcut(base_button->get_shortcut().ptr());
            }

            void setShortcut(bxtk::input::Shortcut* shortcut) {
