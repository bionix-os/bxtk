...
namespace bxtk::ui {
    ...
    class ButtonProxy : public ButtonNode {
        ...
        public:
            bxtk::ui::Button* element = nullptr;
    ...
    class Button : public bxtk::ui::BaseButton {
        private:
        ...
        public:
            ...
            bxtk::core::Texture2D* getIcon() {
                return new bxtk::core::Texture2D(button->get_button_icon().ptr());
            }

            void setIcon(bxtk::core::Texture2D* texture) {
