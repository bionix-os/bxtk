...
namespace bxtk::ui {
    ...
    class Theme : public bxtk::core::Resource {
    private:
        GodotTheme* theme;
    public:
        Theme() {
        ...
        bxtk::core::Font* getDefaultFont() {
            return new bxtk::core::Font(theme->get_default_font().ptr());
        }

        void setDefaultFont(bxtk::core::Font* font) {
        ...
        bxtk::core::Font* getFont(const std::string& name, const std::string& type) {
            return new bxtk::core::Font(theme->get_font(name.c_str(), type.c_str()).ptr());
        }
        ...
        bxtk::core::Texture2D* getIcon(const std::string& name, const std::string& type) {
            return new bxtk::core::Texture2D(theme->get_icon(name.c_str(), type.c_str()).ptr());
        }
        ...
        bxtk::ui::StyleBox* getStyleBox(const std::string& name, const std::string& type) {
            return new bxtk::ui::StyleBox(theme->get_stylebox(name.c_str(), type.c_str()).ptr());
        }
        ...
        sol::stack_object getThemeItem(lua_State* L, int dataType, const std::string& name, const std::string& type) {
            return bxtk::core::to_lua(L, theme->get_theme_item(static_cast<GodotTheme::DataType>(dataType), name.c_str(), type.c_str()));
        }
        ...
        void setFont(const std::string& name, const std::string& type, bxtk::core::Font* font) {
        ...
        void setIcon(const std::string& name, const std::string& type, bxtk::core::Texture2D* icon) {
            theme->set_icon(name.c_str(), type.c_str(), godot::Ref<GodotTexture2D>(icon->getTexture()));
        }

        void setStyleBox(const std::string& name, const std::string& type, bxtk::ui::StyleBox* styleBox) {
