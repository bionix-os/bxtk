...
namespace bxtk::ui {
    ...
    class MenuBarProxy : public MenuBarNode {
        ...
        public:
            bxtk::ui::MenuBar* element = nullptr;
    ...
    class MenuBar : public bxtk::ui::Control {
        private:
        ...
        bxtk::desktop::PopupMenu* getMenuPopup(int32_t p_menu) {
            return new bxtk::desktop::PopupMenu(menuBar->get_menu_popup(p_menu));
        }
