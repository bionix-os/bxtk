...
namespace bxtk::ui {
    ...
    class TextEditProxy : public TextEditNode {
        ...
        public:
            bxtk::ui::TextEdit* element = nullptr;
    ...
    class TextEdit : public Control {
        ...
        public:
            ...
            bxtk::core::Texture2D* getLineGutterIcon(int line, int gutter) {
                return new bxtk::core::Texture2D(text_edit->get_line_gutter_icon(line, gutter).ptr());
            }
            ...
            bxtk::desktop::PopupMenu* getMenu() {
                return new bxtk::desktop::PopupMenu(text_edit->get_menu());
            }
            ...
            void setLineGutterIcon(int line, int gutter, bxtk::core::Texture2D* icon) {
