...
namespace bxtk::ui {
    ...
    class TreeItem : public BaseObject {
        ...
        public:
            ...
            void addButton(int column, bxtk::core::Texture2D* button, int id = -1, bool disabled = false, std::string toolTipText = "") {
            ...
            bxtk::core::Texture2D* getButton(int column, int idx) const {
                return new bxtk::core::Texture2D(tree_item->get_button(column, idx).ptr());
            }
            ...
            bxtk::core::Font* getCustomFont(int column) const {
                return new bxtk::core::Font(tree_item->get_custom_font(column).ptr());
            }
            ...
            bxtk::core::Texture2D* getIcon(int column) const {
                return new bxtk::core::Texture2D(tree_item->get_icon(column).ptr());
            }
            ...
            bxtk::core::Texture2D* getIconOverlay(int column) const {
                return new bxtk::core::Texture2D(tree_item->get_icon_overlay(column).ptr());
            }
            ...
            void setButton(int column, int buttonIdx, bxtk::core::Texture2D* button) {
            ...
            void setCustomFont(int column, bxtk::core::Font* font) {
            ...
            void setIcon(int column, bxtk::core::Texture2D* texture) {
            ...
            void setIconOverlay(int column, bxtk::core::Texture2D* texture) {
