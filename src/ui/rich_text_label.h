...
namespace bxtk::ui {
    ...
    class RichTextLabelProxy : public RichTextLabelNode {
        ...
        public:
            bxtk::ui::RichTextLabel* element = nullptr;
    ...
    class RichTextLabel : public Control {
        ...
        public:
            ...
            void addImage(bxtk::core::Texture2D* image, int width = 0, int height = 0, Color color = Color(1, 1, 1, 1), int inlineAlign = 5, Rect2 region = Rect2(0, 0, 0, 0), Variant key = Variant(), bool pad = false, std::string tooltip = "''", bool sizeInPercent = false) {
            ...
            bxtk::desktop::PopupMenu* getMenu() {
                return new bxtk::desktop::PopupMenu(rich_text_label->get_menu());
            }
            ...
            void pushDropcap(std::string string, bxtk::core::Font* font, int size, Rect2 dropcapMargins = Rect2(0, 0, 0, 0), Color color = Color(1, 1, 1, 1), int outlineSize = 0, Color outlineColor = Color(0, 0, 0, 0)) {
            ...
            void pushFont(bxtk::core::Font* font, int fontSize = 0) {
            ...
            void updateImage(Variant key, int mask, bxtk::core::Texture2D* image, int width = 0, int height = 0, Color color = Color(1, 1, 1, 1), int inlineAlign = 5, Rect2 region = Rect2(0, 0, 0, 0), bool pad = false, std::string tooltip = "", bool sizeInPercent = false) {
