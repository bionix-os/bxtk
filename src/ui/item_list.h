...
namespace bxtk::ui {
    ...
    class ItemListProxy : public ItemListNode {
        ...
        public:
            bxtk::ui::ItemList* element = nullptr;
        ...
        public:
            ...
            int addIconItem(bxtk::core::Texture2D* texture, bool selectable = true) {
            ...
            int addItem(std::string text, bxtk::core::Texture2D* icon = nullptr, bool selectable = true) {
            ...
            bxtk::core::Texture2D* getItemIcon(int index) {
                Ref<godot::Texture2D> textureRef = item_list->get_item_icon(index);
                return new bxtk::core::Texture2D(textureRef.ptr());
            }
