...
namespace bxtk::ui {
    ...
    class CodeEditProxy : public CodeEditNode {
        ...
        public:
            bxtk::ui::CodeEdit* element = nullptr;
    ...
    class CodeEdit : public TextEdit {
        ...
        public:
            ...
            void addCodeCompletionOption(int type, const std::string& displayText, const std::string& insertText, const Color textColor, bxtk::core::Resource* icon = nullptr, Variant value = Variant(), int location = 1024) {
