...
namespace bxtk::ui {
    ...
    class TextureButtonProxy : public TextureButtonNode {
        ...
        public:
            bxtk::ui::TextureButton* element = nullptr;
    ...
    class TextureButton : public BaseButton {
        ...
        public:
            ...
            bxtk::core::BitMap* getTextureClickMask() const {
                return new bxtk::core::BitMap(this->texture_button->get_click_mask().ptr());
            }

            void setTextureClickMask(bxtk::core::BitMap* mask) {
                this->texture_button->set_click_mask(mask->getBitMap());
            }

            bxtk::core::Texture2D* getTextureDisabled() const {
                return new bxtk::core::Texture2D(this->texture_button->get_texture_disabled().ptr());
            }

            void setTextureDisabled(bxtk::core::Texture2D* texture) {
                this->texture_button->set_texture_disabled(texture->getTexture2D());
            }

            bxtk::core::Texture2D* getTextureFocused() const {
                return new bxtk::core::Texture2D(this->texture_button->get_texture_focused().ptr());
            }

            void setTextureFocused(bxtk::core::Texture2D* texture) {
                this->texture_button->set_texture_focused(texture->getTexture2D());
            }

            bxtk::core::Texture2D* getTextureHover() const {
                return new bxtk::core::Texture2D(this->texture_button->get_texture_hover().ptr());
            }

            void setTextureHover(bxtk::core::Texture2D* texture) {
                this->texture_button->set_texture_hover(texture->getTexture2D());
            }

            bxtk::core::Texture2D* getTextureNormal() const {
                return new bxtk::core::Texture2D(this->texture_button->get_texture_normal().ptr());
            }

            void setTextureNormal(bxtk::core::Texture2D* texture) {
                this->texture_button->set_texture_normal(texture->getTexture2D());
            }

            bxtk::core::Texture2D* getTexturePressed() const {
                return new bxtk::core::Texture2D(this->texture_button->get_texture_pressed().ptr());
            }

            void setTexturePressed(bxtk::core::Texture2D* texture) {
