...
namespace bxtk::ui {
    ...
    void bxtk::ui::ControlProxy::_enter_tree() {
        if (this->element != nullptr) {
            this->element->enterTree();
        }
    }
    
    void bxtk::ui::ControlProxy::_exit_tree() {
        if (this->element != nullptr) {
            this->element->exitTree();
        }
    }
    
    void bxtk::ui::ControlProxy::_ready() {
        if (this->element != nullptr) {
            this->element->ready();
        }
    }
    
    void bxtk::ui::ControlProxy::_process(double delta) {
        if (this->element != nullptr) {
            this->element->process(delta);
        }
    }
    
    void bxtk::ui::ControlProxy::_physics_process(double delta) {
        if (this->element != nullptr) {
            this->element->physicsProcess(delta);
        }
    }
    
    void bxtk::ui::ControlProxy::_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->input(event);
        }
    }
    
    void bxtk::ui::ControlProxy::_unhandled_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledInput(event);
        }
    }
    
    void bxtk::ui::ControlProxy::_unhandled_key_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
            this->element->unhandledKeyInput(event);
        }
    }
    
    void bxtk::ui::ControlProxy::_shortcut_input(const Ref<InputEvent>& event) {
        if (this->element != nullptr) {
    ...
    void bindControl(sol::state& lua) {
        auto ut = lua.new_usertype<Control>("Control",
            ...
            sol::base_classes, sol::bases<BaseObject, Element, bxtk::core::CanvasItem>(),
