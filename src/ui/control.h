...
namespace bxtk::ui {
    ...
    class ControlProxy : public ControlNode {
        ...
        public:
            bxtk::ui::Control* element = nullptr;
    ...
    class Control : public bxtk::core::CanvasItem {
        private:
        ...
        public:
            ...
            void addThemeIconOverride(std::string name, bxtk::core::Texture2D* texture) {
            ...
            bxtk::core::Font* getThemeDefaultFont() {
                return new bxtk::core::Font(control->get_theme_default_font().ptr());
            }
            ...
            bxtk::core::Font* getThemeFont(std::string name, std::string type = String(StringName("&")).utf8().get_data()) {
                return new bxtk::core::Font(control->get_theme_font(name.c_str(), type.c_str()).ptr());
            }
            ...
            bxtk::core::Texture2D* getThemeIcon(std::string name, std::string type = String(StringName("&")).utf8().get_data()) {
                return new bxtk::core::Texture2D(control->get_theme_icon(name.c_str(), type.c_str()).ptr());
            }
