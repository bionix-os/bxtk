...
namespace bxtk::desktop {
    ...
    public:
        bxtk::desktop::PopupMenu* element = nullptr;
    ...
    class PopupMenu : public Popup {
        ...
        public:
            ...
            bool activateItemByEvent(bxtk::input::InputEvent* event, bool forGlobalOnly = false) {
            ...
            void addCheckShortcut(bxtk::input::Shortcut* shortcut, int id  = -1, bool global = false) {
                popup_menu->add_check_shortcut(shortcut->getShortcut(), id, global);
            }

            void addIconCheckItem(bxtk::core::Texture2D* texture, std::string label, int id = -1, int accel = 0) {
                popup_menu->add_icon_check_item(texture->getTexture2D(), label.c_str(), id, static_cast<godot::Key>(accel));
            }

            void addIconCheckShortcut(bxtk::core::Texture2D* texture, bxtk::input::Shortcut* shortcut, int id = -1, bool global = false) {
                popup_menu->add_icon_check_shortcut(texture->getTexture2D(), shortcut->getShortcut(), id, global);
            }

            void addIconItem(bxtk::core::Texture2D* texture, std::string label, int id = -1, int accel = 0) {
                popup_menu->add_icon_item(texture->getTexture2D(), label.c_str(), id, static_cast<godot::Key>(accel));
            } 

            void addIconRadioCheckItem(bxtk::core::Texture2D* texture, std::string label, int id = -1, int accel = 0) {
                popup_menu->add_icon_radio_check_item(texture->getTexture2D(), label.c_str(), id, static_cast<godot::Key>(accel));
            }

            void addIconRadioCheckShortcut(bxtk::core::Texture2D* texture, bxtk::input::Shortcut* shortcut, int id = -1, bool global = false) {
                popup_menu->add_icon_radio_check_shortcut(texture->getTexture2D(), shortcut->getShortcut(), id, global);
            }

            void addIconShortcut(bxtk::core::Texture2D* texture, bxtk::input::Shortcut* shortcut, int id = -1, bool global = false, bool allowEcho = false) {
            ...
            void addRadioCheckShortcut(bxtk::input::Shortcut* shortcut, int id = -1, bool global = false) {
            ...
            void addShortcut(bxtk::input::Shortcut* shortcut, int id = -1, bool global = false, bool allowEcho = false) {
            ...
            bxtk::core::Texture2D* getItemIcon(int index) const {
                return new bxtk::core::Texture2D(popup_menu->get_item_icon(index).ptr());
            }
            ...
            bxtk::input::Shortcut* getItemShortcut(int index) const {
                return new bxtk::input::Shortcut(popup_menu->get_item_shortcut(index).ptr());
            }
            ...
            void setItemIcon(int index, bxtk::core::Texture2D* texture) {
            ...
            void setItemShortcut(int index, bxtk::input::Shortcut* shortcut, bool global = false) {
