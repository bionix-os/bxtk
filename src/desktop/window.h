...
namespace bxtk::desktop {
    ...
    class WindowProxy : public WindowNode {
        ...
        public:
            bxtk::desktop::Window* element = nullptr;
    ...
    class Window : public bxtk::core::Viewport {
        private:
        ...
        public:
            ...
            void setWindow(WindowNode* window) {
                this->window = window;
                this->window->set_theme(Ref<godot::Theme>(bxtk::ui::uiGlobals::getGlobalTheme()->getTheme()));
            ...
            bxtk::ui::Theme* getTheme() {
                return new bxtk::ui::Theme(window->get_theme().ptr());
            }

            void setTheme(bxtk::ui::Theme* theme) {
            ...
            void addThemeFontOverride(std::string name, bxtk::core::Font* font) {
            ...
            void addThemeIconOverride(std::string name, bxtk::core::Texture2D* icon) {
                window->add_theme_icon_override(name.c_str(), Ref<godot::Texture2D>(icon->getTexture()));
            }

            void addThemeStyleBoxOverride(std::string name, bxtk::ui::StyleBox* stylebox) {
            ...
            bxtk::core::Font* getThemeDefaultFont() {
                return new bxtk::core::Font(window->get_theme_default_font().ptr());
            }
            ...
            bxtk::core::Font* getThemeFont(std::string name, std::string type = "&") {
                return new bxtk::core::Font(window->get_theme_font(name.c_str(), type.c_str()).ptr());
            }
            ...
            bxtk::core::Texture2D* getThemeIcon(std::string name, std::string type = "&") {
                return new bxtk::core::Texture2D(window->get_theme_icon(name.c_str(), type.c_str()).ptr());
            }

            bxtk::ui::StyleBox* getThemeStyleBox(std::string name, std::string type = "&") {
                return new bxtk::ui::StyleBox(window->get_theme_stylebox(name.c_str(), type.c_str()).ptr());
            }
